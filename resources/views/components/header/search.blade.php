<form {{ $attributes->merge(['class' => 'w-full relative']) }}
	...
	<input name="term" type="search" autocomplete="off" data-lpignore="true" data-bitwarden-ignore
	...
	<button
		class="absolute p-2 text-white transition -translate-y-1/2 rounded-full right-3 top-1/2 hover:text-[#71C229]">
