<div class="sm:relative"
    ...
    <button class="flex items-center gap-2 px-6 py-2.5 transition border border-white rounded-full hover:bg-white hover:text-black group"
        ...
        <span class="text-sm font-bold">({{ $this->cartLines->sum('quantity') }})</span>
    </button>
