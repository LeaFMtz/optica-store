        ...
        <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-12 gap-6">
            <div class="space-y-2">
                ...
                <p class="text-gray-500 text-sm max-w-2xl">
                    Descubre nuestra exclusiva selección de productos diseñados para tu salud visual y estilo.
                </p>
            </div>
            ...
            <div class="bg-white px-6 py-3 rounded-full border border-gray-100 shadow-sm">
                ...
                <span class="text-sm text-gray-900 font-black ml-1">{{ $this->collection->products->count() }} Productos</span>
            </div>
        </div>
