    ...
    <div class="bg-gray-50 min-h-screen">
        ...
        <header class="bg-white border-b border-gray-100 py-16">
            <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8 text-center">
                <nav
                    class="flex justify-center mb-4 text-[10px] font-bold tracking-widest uppercase text-gray-400 space-x-2">
                ...
                <h1 class="text-4xl font-black text-gray-900 sm:text-6xl tracking-tight uppercase">
                    Nuestres <span class="text-[#71C229]">Productos</span>
                </h1>
        ...
        <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8 py-12">
            ...
            <div
                class="flex flex-col sm:flex-row sm:items-center justify-between mb-12 pb-6 border-b border-gray-100 gap-4">
                <div class="text-sm text-gray-500">
                    Mostrando <span class="text-gray-900 font-bold">{{ $this->products->firstItem() }}</span> - <span
                        class="text-gray-900 font-bold">{{ $this->products->lastItem() }}</span> de <span
                        class="text-gray-900 font-bold">{{ $this->products->total() }}</span> items
                </div>
