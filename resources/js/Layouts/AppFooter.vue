    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4">
      ...
      <div class="flex flex-col items-center text-center mb-16">
        ...
        <div class="flex flex-col sm:flex-row gap-0 w-full max-w-lg group">
          <input type="email" placeholder="Email" class="flex-1 bg-transparent border border-gray-700 rounded-l-md py-3 px-4 focus:outline-none focus:border-primary-500 text-white transition-colors">
          <button type="button" class="bg-black text-white font-bold py-3 px-8 rounded-r-xl hover:bg-primary-500 hover:text-black transition-all duration-500 uppercase text-[10px] tracking-[0.2em]">Enviar</button>
        </div>
      </div>
        ...
        <div class="flex flex-col sm:flex-row md:flex-col justify-between sm:items-center md:items-start gap-8">
          ...
          <div class="space-y-4">
            ...
            <div class="flex space-x-3">
              <a href="#" target="_blank" class="border border-gray-700 rounded-full p-2.5 hover:bg-primary-500 hover:border-primary-500 hover:text-black transition-all">
        ...
        <div class="md:col-span-2 grid grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-3 text-sm text-gray-400">
              ...
              <li class="hover:text-white transition cursor-default">+5493814301312</li>
              <li><a href="mailto:opticaguzmantuc@gmail.com" class="hover:text-primary-500 transition">opticaguzmantuc@gmail.com</a></li>
