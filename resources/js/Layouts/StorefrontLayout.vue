      ...
      <div class="px-4 py-4 mx-auto max-w-screen-2xl sm:px-6 lg:px-8 w-full">
        <div class="flex items-center justify-between gap-4">
          ...
          <div class="hidden lg:flex flex-1">
            <form action="/search" method="GET" class="max-w-xs w-full">
              <input
                type="search"
                name="q"
                placeholder="Buscar..."
                class="w-full bg-gray-900 text-white text-sm rounded px-3 py-2 border border-gray-700 focus:outline-none focus:border-[#71C229] placeholder-gray-500"
              >
            </form>
          </div>
          ...
          <div class="flex-1 flex justify-start lg:justify-center">
            <a class="block hover:opacity-80 transition" href="/">
              <span class="sr-only">Inicio</span>
              <img :src="'/images/logo.webp'" alt="Óptica Guzmán" class="h-10 w-auto lg:h-16 mx-auto">
            </a>
          </div>
          ...
          <div class="flex items-center justify-end flex-1 gap-2 sm:gap-4">
            ...
            <button
              type="button"
              class="relative flex items-center text-white hover:text-[#71C229] transition"
            ...
            >
              ...
              <span
                ...
                class="absolute -top-2 -right-2 bg-[#71C229] text-white text-[10px] font-bold rounded-full w-5 h-5 flex items-center justify-center"
              >{{ localCartCount }}</span>
            </button>
            ...
            <div class="lg:hidden relative">
              <button
                ...
                onclick="this.closest('.relative').querySelector('#mobile-menu').classList.toggle('hidden')"
              >
              ...
              <div id="mobile-menu" class="hidden absolute right-0 top-[60px] z-50 w-screen p-4 sm:max-w-xs">
                <ul class="p-6 space-y-4 bg-[#111] border border-gray-800 shadow-xl rounded-xl text-white text-sm font-medium">
                  <li><a href="/" class="hover:text-[#71C229] transition">Inicio</a></li>
                  <li><a :href="route('catalog.view')" class="hover:text-[#71C229] transition">Todos los productos</a></li>
                  <template v-if="auth?.user">
                    <li><span class="text-gray-400">Hola, {{ auth.user.name }}</span></li>
                    <li><button type="button" class="hover:text-[#71C229] transition" @click="logout">Cerrar sesión</button></li>
                  </template>
                  <template v-else>
                    <li><a :href="route('login')" class="hover:text-[#71C229] transition">Iniciar sesión</a></li>
                    <li><a :href="route('register')" class="hover:text-[#71C229] transition">Crear cuenta</a></li>
                  </template>
                </ul>
              </div>
            </div>
        ...
        <!-- Desktop nav -->
        <nav class="mt-4 hidden lg:flex justify-center gap-6 text-xs font-bold text-white/80 border-t border-gray-800 pt-4 pb-2">
          <a :href="route('catalog.view')" class="hover:text-[#71C229] transition py-2 inline-block">Todos</a>
        </nav>
      </div>
    </header>
  </div>
  ...
  <footer class="bg-black text-white pt-16 pb-12 border-t border-gray-800 relative mt-auto">
    <div class="relative z-10 max-w-7xl mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-12 border-t border-gray-900 pt-12">
        ...
        <div class="flex flex-col sm:flex-row md:flex-col justify-between sm:items-center md:items-start gap-8">
          <div class="flex-shrink-0">
            <img :src="'/images/logo.webp'" alt="Óptica Guzmán" class="h-12 w-auto">
          </div>
          <div class="space-y-4">
        ...
        <div class="md:col-span-2 grid grid-cols-2 gap-8">
          <div>
            ...
            <ul class="space-y-3 text-sm text-gray-400">
              <li><a href="/" class="hover:text-[#71C229] transition">Inicio</a></li>
              <li><a :href="route('catalog.view')" class="hover:text-[#71C229] transition">Productos</a></li>
              <li><a :href="route('contact.view')" class="hover:text-[#71C229] transition">Contacto</a></li>
              <li><a :href="route('refund-policy.view')" class="hover:text-[#71C229] transition">Política de Devolución</a></li>
              <li><a :href="route('faq.view')" class="hover:text-[#71C229] transition">Preguntas Frecuentes</a></li>
            </ul>
          </div>
          <div>
      ...
      <div class="mt-16 pt-8 border-t border-gray-900 text-center text-[10px] font-bold uppercase tracking-widest text-gray-600">
        &copy; {{ new Date().getFullYear() }} Óptica Guzmán. Todos los derechos reservados.
      </div>
    </div>

    <!-- WhatsApp floating -->
    <a href="https://wa.me/5493814301312" target="_blank" class="fixed bottom-6 right-6 bg-[#25D366] text-white p-3 rounded-full shadow-lg hover:scale-110 transition-all z-50">
