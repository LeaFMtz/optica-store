        ...
        <form @submit.prevent="submit" class="space-y-3">
          ...
          <div>
            ...
            <textarea
              ...
              rows="2"
              class="w-full px-3 py-2 bg-gray-50 border border-gray-100 rounded focus:ring-1 focus:ring-[#71C229] outline-none text-sm transition resize-none"
            ></textarea>
          </div>
          ...
          <div class="pt-2">
            <button
              ...
              class="w-full bg-black text-white py-3 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-[#71C229] transition shadow-md disabled:opacity-50"
            >
