  ...
  <div class="max-w-2xl mx-auto my-8 px-4">
    ...
    <div class="bg-white shadow-xl rounded-xl border border-gray-100 overflow-hidden">
      ...
      <div class="p-8 space-y-10">
        <!-- ¿Cómo comprar? -->
        <section>
          <h2 class="text-xl font-bold text-primary-500 mb-4">¿Cómo comprar?</h2>
        ...
        <!-- ¿Quiero lentes con graduación? -->
        <section>
          <h2 class="text-xl font-bold text-primary-500 mb-3">¿Quiero mis lentes con graduación?</h2>
        ...
        <!-- ¿Realizan envíos? -->
        <section>
          <h2 class="text-xl font-bold text-primary-500 mb-3">¿Realizan envíos?</h2>
          <p class="text-sm text-gray-600 leading-relaxed">
        ...
        <!-- ¿El precio incluye lentes? -->
        <section>
          <h2 class="text-xl font-bold text-primary-500 mb-3">¿El precio publicado de los armazones incluye lentes?</h2>
          <p class="text-sm text-gray-600 leading-relaxed">
      ...
      <div class="p-4 bg-primary-500/5 text-center">
        <p class="text-[10px] text-primary-500 font-bold uppercase tracking-widest">Óptica Guzmán &bull; Calidad a tu medida</p>
      </div>
    </div>
  </div>
</template>
